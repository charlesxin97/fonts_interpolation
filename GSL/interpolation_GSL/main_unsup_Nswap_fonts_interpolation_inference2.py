...
from solver_unsup_Nswap_fonts_interpolation_inference2 import Solver
from utils_gsl import str2bool
...
if __name__ == "__main__":
    ...
    parser.add_argument('--viz_name', default='fonts_Nswap_interpolation_inference', type=str, help='visdom env name')
    ...
    parser.add_argument('--model_save_dir', default='checkpoints', type=str, help='output directory')
    parser.add_argument('--resume_iters', type=int, default=180000, help='resume training from this step')

    parser.add_argument('--gather_step', default=1, type=int, help='numer of iterations after which data is gathered for visdom')
    ...
    parser.add_argument('--save_step', default=100000, type=int, help='number of iterations after which a checkpoint is saved')
