...
from solver_unsup_Nswap_fonts_interpolation_inference import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--viz_name', default='fonts_Nswap_interpolation_inference_rgb', type=str, help='visdom env name')
