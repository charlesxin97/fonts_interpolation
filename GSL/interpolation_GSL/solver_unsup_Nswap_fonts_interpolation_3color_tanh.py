...
from model_sup_changeZdim_interpolation import Generator_fc_tanh
from dataset_Nswap_fonts_interpolation_3color_tanh import return_data
...
class Solver(object):
    def __init__(self, args):
        ...
        self.Autoencoder = Generator_fc_tanh(self.nc, self.g_conv_dim, self.g_repeat_num, self.z_dim)
