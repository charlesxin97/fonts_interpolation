...
from solver_unsup_Nswap_fonts_interpolation_3color_tanh import Solver
...
if __name__ == "__main__":
    ...
    parser.add_argument('--viz_name', default='fonts_Nswap_interpolation_rgb', type=str, help='visdom env name')
